...
elseif (is_arg('-h')) then
  ...
  print '(a)', ' '
    print '(a)', '    -gmi'
  print '(a)', '        When a .msh file appears, format applied is Gmsh MSH ASCII format for input file; if absent, format applied is'
  print '(a)', '        ANSYS MSH format'
  print '(a)', ' '
    print '(a)', '    -gmo'
  print '(a)', '        When a .msh file appears, format applied is Gmsh MSH ASCII format for output file; if absent, format applied is'
  print '(a)', '        ANSYS MSH format'
  print '(a)', ' '
    print '(a)', '    -gmsh'
  print '(a)', '        When a .msh file appears, format applied is Gmsh MSH ASCII format for output file; if absent, format applied is'
